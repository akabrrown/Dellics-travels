          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            <div className="footer-brand space-y-4">
              ...
              <div className="flex items-center gap-3 pt-2">
                <Link href="#" className="w-8 h-8 rounded-full bg-slate-200 flex items-center justify-center text-slate-600 hover:bg-brand-blue hover:text-white transition-colors" aria-label="Facebook">
                  f
                </Link>
                <Link href="#" className="w-8 h-8 rounded-full bg-slate-200 flex items-center justify-center text-slate-600 hover:bg-brand-blue hover:text-white transition-colors" aria-label="Instagram">
                  in
                </Link>
