export default function AdminEsimsLoading() {
  return (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        {[1, 2, 3, 4, 5].map((i) => (
          <div key={i} className="bg-white rounded-2xl p-4 border border-slate-100 shadow-xs space-y-3">
            ...
            <div className="h-7 w-28 bg-slate-300 rounded-lg animate-pulse" />
        ...
        <div className="divide-y divide-slate-100">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="px-6 py-4 flex items-center justify-between">
              ...
              <div className="h-6 w-24 bg-blue-50 rounded-lg animate-pulse" />
              <div className="h-6 w-24 bg-emerald-50 rounded-lg animate-pulse" />
