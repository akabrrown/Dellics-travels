export default function AdminTravelersLoading() {
  return (
    <div className="space-y-6 animate-in fade-in duration-300 pb-12">
      ...
      <div className="bg-white rounded-2xl p-4 border border-slate-100 shadow-xs flex items-center gap-3">
        <div className="h-10 flex-1 bg-slate-50 rounded-xl border border-slate-100 animate-pulse" />
        <div className="h-10 w-36 bg-slate-50 rounded-xl border border-slate-100 animate-pulse" />
      </div>
        ...
        <div className="divide-y divide-slate-100">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="px-6 py-4 flex items-center justify-between gap-4">
              ...
              <div className="h-4 w-28 bg-slate-100 rounded animate-pulse hidden sm:block" />
