...
const SLIDES = [
  {
    id: '1',
    title: 'Verified Airline\nTicketing',
    description: 'Direct bookings on Emirates, Qatar, British Airways & Delta with 24/7 WhatsApp concierge.',
    icon: Plane,
    color: '#0A0060',
    bg: '#EAF0FA',
  },
  {
    id: '2',
    title: 'Stays, Transfers\n& Curated Tours',
    description: 'From 5-star Dubai holidays to Cape Coast diaspora expeditions and VIP airport chauffeur protocol.',
    icon: Compass,
    color: '#F4740D',
    bg: '#FFF3E8',
  },
  {
    id: '3',
    title: 'Voyager Club\nRewards',
    description: 'Earn points on every journey and redeem for seat upgrades, luggage allowances, and fare discounts.',
    icon: Award,
    color: '#1E7A34',
    bg: '#EAF4EC',
  },
