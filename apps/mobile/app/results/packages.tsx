  ...
  return (
    <SafeAreaView className="flex-1 bg-[#F9FAFB]">
      <View className="flex-row items-center px-4 py-3 bg-white border-b border-gray-100 shadow-sm">
        ...
        <Text className="text-lg font-black text-[#0A0060]">Packages</Text>
      </View>
      <View className="flex-1 items-center justify-center p-6">
        <View className="w-16 h-16 bg-[#0A0060]/5 rounded-full items-center justify-center mb-4">
          <Briefcase size={24} color="#0A0060" />
        </View>
        <Text className="text-xl font-bold text-gray-900 mb-2">Package Results Coming Soon</Text>
      </View>
    </SafeAreaView>
  );
}
