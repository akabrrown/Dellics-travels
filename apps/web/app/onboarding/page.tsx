            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  >
                    <option value="ACC - Kotoka International (Accra, Ghana)">ACC - Kotoka International (Accra, Ghana)</option>
                    <option value="LOS - Murtala Muhammed (Lagos, Nigeria)">LOS - Murtala Muhammed (Lagos, Nigeria)</option>
                    <option value="LHR - London Heathrow (United Kingdom)">LHR - London Heathrow (United Kingdom)</option>
                    <option value="JFK - New York JFK (United States)">JFK - New York JFK (United States)</option>
                    <option value="DXB - Dubai International (UAE)">DXB - Dubai International (UAE)</option>
                    <option value="NBO - Jomo Kenyatta (Nairobi, Kenya)">NBO - Jomo Kenyatta (Nairobi, Kenya)</option>
                  </select>
                </div>
