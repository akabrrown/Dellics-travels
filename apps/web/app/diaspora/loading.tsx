      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-6 relative z-20 space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {[1, 2].map((i) => (
            <div
              key={i}
              className="bg-white rounded-3xl overflow-hidden border border-slate-200/80 shadow-xs space-y-4 p-6"
            >
              ...
              <div className="h-11 w-40 bg-brand-orange/20 rounded-2xl animate-pulse" />
            </div>
          ))}
        </div>
      </div>
