      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-6 relative z-20 space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="bg-white rounded-3xl p-8 border border-slate-200/80 shadow-xs space-y-6"
            >
              <div className="size-14 bg-orange-100 rounded-2xl animate-pulse" />
              ...
              <div className="space-y-2">
                ...
                <div className="h-3.5 w-5/6 bg-slate-100 rounded-md animate-pulse" />
              </div>
              <div className="h-11 w-full bg-navy/20 rounded-2xl animate-pulse" />
            </div>
          ))}
        </div>
      </div>
