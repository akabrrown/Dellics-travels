...
export const HERO_SLIDES: HeroSlide[] = [
  {
    ...
    caption: "Dellics Travels - IATA Accredited Global Luxury Travel Management",
...
export const FLIGHT_HERO_SLIDES: HeroSlide[] = [
  {
    ...
    subtitle: "IATA Accredited airline ticketing across 500+ global carriers with zero hidden fees and instant PNR issuance.",
